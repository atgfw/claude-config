 ...
 */
export async function preTaskCompleteHook(_input) {
    ...
    if (!flagExists(VISUAL_VALIDATION_NEEDED_FLAG)) {
        ...
        logBlocked('Cannot mark task complete - frontend code was written', 'Task completion requires visual validation using MCP tools.');
        log('');
...
//# sourceMappingURL=pre_task_complete.js.map