 ...
 */
export async function promptEscalationDetectorHook(input) {
        ...
        for (const pattern of intent.patterns) {
            ...
            if (match) {
                try {
                    ...
                    log(`[ESCALATION-ERROR] ${intent.name}: ${error.message}`);
                }
            }
        }
    }
...
//# sourceMappingURL=prompt_escalation_detector.js.map