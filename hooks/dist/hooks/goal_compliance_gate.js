...
import { getSessionId, loadGoalStack } from '../session/goal_stack.js';
// ============================================================================
// Goal Field Analysis
// ============================================================================
/**
 ...
 */
function hasActionTitle(summary) {
    if (!summary)
        return false;
    ...
    if (vagueStarters.includes(firstWord))
        return false;
    return true;
}
/**
 ...
 */
function hasTargetObject(fields) {
 ...
 */
function hasFailureModes(fields) {
 ...
 */
function hasDependencies(fields) {
 ...
 */
function hasSuccessMetrics(fields) {
 ...
 */
export function validateGoalCompliance(goal) {
    const checks = [];
 ...
 */
async function goalComplianceGateHook(input) {
...
//# sourceMappingURL=goal_compliance_gate.js.map