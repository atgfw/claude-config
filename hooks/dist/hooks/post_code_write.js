 ...
 */
export async function postCodeWriteHook(input) {
    ...
    if (!flagExists(REVIEW_FLAG)) {
        logBlocked('Code review required before continuing', 'After writing code | code-reviewer | Immediately after Write/Edit');
        log('');
        log('REQUIRED ACTION:');
...
//# sourceMappingURL=post_code_write.js.map