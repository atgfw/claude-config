...
// State Management
// ============================================================================
function getStateFiles(projectRoot) {
...
// Message Builder
// ============================================================================
function buildMandatoryMessage(detection, sessionState) {
...
// Main Hook
// ============================================================================
export async function workflowIntentHook(input) {
    ...
    const intentState = readJsonFile(intentFile, { timestamp: 0 });
    const sessionState = readJsonFile(stateFile, { n8nUp: false, workflowCount: 0 });
...
//# sourceMappingURL=workflow_intent.js.map