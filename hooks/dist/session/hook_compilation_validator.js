 ...
 */
function findSourceFiles(srcDirectory) {
    const files = [];
 ...
 */
export function findStaleCompilations(hooksDirectoryPath) {
 ...
 */
export function rebuildHooks(hooksDirectoryPath) {
    const baseDirectory = hooksDirectoryPath ?? getHooksDirectory();
    try {
 ...
 */
export function validateHookCompilation(hooksDirectoryPath) {
    const baseDirectory = hooksDirectoryPath ?? getHooksDirectory();
...
//# sourceMappingURL=hook_compilation_validator.js.map