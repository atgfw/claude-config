 ...
 */
function matchesCleanupRule(filePath, stats) {
 ...
 */
function processFileEntry(fullPath, staleFiles) {
    try {
 ...
 */
function findStaleFiles(directory, maxDepth = 3, currentDepth = 0) {
    const staleFiles = [];
 ...
 */
function archiveStaleFiles(staleFiles, baseDirectory) {
    const archived = [];
    const failed = [];
 ...
 */
export function cleanupProject(projectDirectory) {
...
//# sourceMappingURL=project_cleanup.js.map