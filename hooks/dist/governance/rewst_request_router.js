...
const ROUTING_RULES = [
    {
        ...
        context: 'Rewst Jinja expression work detected. Consider using rewst-jinja-orchestrator subagent.',
    },
    {
    ...
    },
    {
        ...
        agent: 'debugger',
        context: 'Debugging request detected. Consider using debugger subagent for root cause analysis.',
    },
    {
...
// #endregion helpers
// #region main
export async function rewstRequestRouterHook(input) {
...
// #endregion main
//# sourceMappingURL=rewst_request_router.js.map