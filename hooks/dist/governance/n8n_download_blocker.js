...
export async function n8nDownloadBlockerHook(input) {
    ...
    return {
        hookSpecificOutput: {
            ...
            permissionDecisionReason: `BLOCKED: Downloading full workflow JSON is not allowed. ` +
...
//# sourceMappingURL=n8n_download_blocker.js.map