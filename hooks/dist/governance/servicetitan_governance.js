 ...
 */
function isServiceTitanTool(toolName) {
 ...
 */
export async function servicetitanGovernanceHook(input) {
    ...
    return {
        hookSpecificOutput: {
            ...
            permissionDecisionReason: `ServiceTitan operation ${operationName} is blocked to reduce context bloat. ` +
...
//# sourceMappingURL=servicetitan_governance.js.map