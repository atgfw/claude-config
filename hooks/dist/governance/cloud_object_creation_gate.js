 ...
 */
export function isCloudCreationTool(toolName) {
 ...
 */
export function extractEntityName(toolInput) {
    // Direct name field
 ...
 */
export function findProjectDirective(startDir) {
 ...
 */
export function checkTestRunRegistry(registryPath, entityName) {
...
// Hook Implementation
// ============================================================================
export async function cloudObjectCreationGateHook(input, options) {
    ...
    if (!directive) {
        ...
        return deny(`BLOCKED: Missing PROJECT-DIRECTIVE.md in ${cwd} or any parent directory. ` +
    ...
    if (!specExists) {
        ...
        return deny(`BLOCKED: Missing spec for entity "${entityName}". ` +
    ...
    if (novelRuns < REQUIRED_NOVEL_RUNS) {
        logBlocked(`Primordial pipeline incomplete: ${novelRuns}/${REQUIRED_NOVEL_RUNS} novel runs for ${entityName}`, 'Cloud Object Creation Gate');
        return deny(`BLOCKED: Primordial pipeline incomplete: ${novelRuns}/${REQUIRED_NOVEL_RUNS} novel runs for "${entityName}". ` +
    ...
    if (!localExists) {
        ...
        return deny(`BLOCKED: No local files for entity "${entityName}". ` +
...
//# sourceMappingURL=cloud_object_creation_gate.js.map