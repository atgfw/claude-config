...
function countMarkers(basePath, markers) {
    return markers.filter((marker) => checkFileExists(basePath, marker)).length;
}
function detectN8nApiUrl(basePath) {
...
export function detectProjectContext(workingDirectory) {
