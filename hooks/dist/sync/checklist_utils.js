 ...
 */
export function generateItemId(text) {
 ...
 */
export function computeChecklistHash(items) {
    if (items.length === 0) {
        return '';
    }
 ...
 */
export function createChecklistItem(text, status = 'pending', modifiedBy = 'claude_task') {
    return {
 ...
 */
export function parseCheckboxStatus(checkbox) {
 ...
 */
export function formatCheckboxStatus(status) {
    switch (status) {
        case 'completed':
            return 'x';
        case 'in_progress':
...
export function diffChecklists(registryItems, artifactItems) {
 ...
 */
export function resolveConflict(item1, item2) {
 ...
 */
export function mergeChecklists(registryItems, artifactItems) {
...
//# sourceMappingURL=checklist_utils.js.map