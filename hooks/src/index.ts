...
// OpenSpec issue bridge (auto-creates GitHub issues from proposals)
...
export {
  ...
  validateBody,
  findDuplicates,
} from './github/issue_conventions.js';
export {
  ...
  parseFromTasksMd,
} from './github/unified_checklist.js';
export {
  buildKanbanContext,
  buildRows,
  renderKanban,
...
} from './github/issue_crud.js';
export {
  type SyncEntry,
  type SyncRegistry,
  loadRegistry as loadIssueSyncRegistry,
  saveRegistry as saveIssueSyncRegistry,
  findEntry as findSyncEntry,
  upsertEntry as upsertSyncEntry,
  syncFromGitHub,
  onTaskComplete,
  linkTask,
  linkOpenSpec,
