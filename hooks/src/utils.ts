 ...
 */
export function getOldDir(): string {
 ...
 */
export function archiveFile(filePath: string): void {
 ...
 */
export function flagExists(flagName: string): boolean {
 ...
 * Create a flag file
 */
export function createFlag(flagName: string): void {
  const flagPath = path.join(getClaudeDir(), flagName);
 ...
 */
export function setFlag(flagName: string): void {
  createFlag(flagName);
}
 ...
 * Archive a flag file (instead of deleting)
 */
export function archiveFlag(flagName: string): void {
  const flagPath = path.join(getClaudeDir(), flagName);
