 ...
 */
function generateTaskGoalId(subject: string): string {
 ...
 */
async function taskGoalSyncCreate(input: PreToolUseInput): Promise<PreToolUseOutput> {
  ...
  const taskInput = input.tool_input as unknown as TaskCreateInput;
 ...
 */
async function taskGoalSyncUpdate(input: PreToolUseInput): Promise<PreToolUseOutput> {
  ...
  const taskInput = input.tool_input as unknown as TaskUpdateInput;
  const sessionId = getSessionId();
