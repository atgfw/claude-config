 ...
 */
function isSuccessfulOperation(output: unknown): boolean {
 ...
 */
function findTempWorkflowFiles(projectDir: string): string[] {
...
export async function n8nPostUpdateCleanupHook(
