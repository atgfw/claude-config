...
function executeGit(
  command: string,
  cwd: string,
  timeoutMs: number = gitFetchTimeoutMs
 ...
 */
export function getCurrentBranch(directory: string): string | undefined {
 ...
 */
export function getRemoteStatus(directory: string): { ahead: number; behind: number } | undefined {
 ...
 * Fetch from remote
 */
export function fetchRemote(directory: string): { success: boolean; error?: string } {
 ...
 */
export function pullRemote(directory: string): { success: boolean; error?: string } {
 ...
 */
export function synchronizeGit(directory: string): SessionCheckResult {
  // Check if git repo
